export const data = [
  {
    ...
    wrongInfo: {
      option1: "Das ist nicht die richtige Antwort, weil Amazon S3 ein Objektspeicher und kein NoSQL-Datenbankdienst ist.",
      option2: "Das ist nicht die richtige Antwort, weil Amazon RDS ein relationaler Datenbankdienst und kein NoSQL-Datenbankdienst ist.",
      option4: "Das ist nicht die richtige Antwort, weil Amazon Redshift ein Data Warehouse Dienst und kein NoSQL-Datenbankdienst ist."
    }
  },
  {
    ...
    wrongInfo: {
      option1: "Das ist nicht die richtige Antwort, weil Amazon EC2 virtuelle Server bietet, aber keine Container-Orchestrierung.",
      option3: "Das ist nicht die richtige Antwort, weil Amazon ECS ein Container-Orchestrierungsdienst ist, aber nicht auf Kubernetes-Basis.",
      option4: "Das ist nicht die richtige Antwort, weil AWS Lambda serverlose Berechnungsressourcen bietet, aber keine Container-Orchestrierung."
    }
  },
  {
    question: "Ein speicherintensiver AWS-Service ist?",
    option1: "Amazon EC2",
    option2: "Amazon RDS",
    option3: "Amazon EBS",
    option4: "Amazon S3",
    ...
    wrongInfo: {
      option1: "Das ist nicht die richtige Antwort, weil Amazon EC2 virtuelle Server bereitstellt, aber kein Speicherdienst ist.",
      option2: "Das ist nicht die richtige Antwort, weil Amazon RDS ein relationaler Datenbankdienst ist und kein Speicherdienst.",
      option3: "Das ist nicht die richtige Antwort, weil Amazon EBS (Elastic Block Store) ein Blockspeicherdienst ist, aber nicht objektbasiert wie S3."
    }
  },
  {
    question: "Ein AWS-Service zur Erstellung einer unveränderlichen Sicherung von Amazon S3-Buckets ist?",
  ...
  {
    question: "Ein AWS-Service, der EC2-Instances automatisch skaliert, ist?",
  ...
  {
    question: "Ein AWS-Service zur automatischen Verschlüsselung von Objekten und Dateien in AWS S3-Buckets ist?",
    option1: "AWS KMS",
    option2: "AWS IAM",
  ...
  {
    question: "Ein AWS-Service, der verteilte Anwendungen mit Microservices erstellt, ist?",
    option1: "Amazon EC2",
    option2: "Amazon S3",
    option3: "Amazon EKS",
    option4: "Amazon ECS",
  ...
  {
    question: "Ein AWS-Service zur Bereitstellung einer relationalen Datenbank in der Cloud ist?",
    option1: "Amazon RDS",
  ...
  {
    question: "Ein AWS-Service zur Bereitstellung virtueller Server in der Cloud ist?",
    option1: "Amazon EC2",
    option2: "Amazon EKS",
    option3: "Amazon S3",
    option4: "Amazon ECS",
  ...
  {
    question: "Ein AWS-Service für Datenanalysen und Business Intelligence (BI) in der Cloud ist?",
    option1: "Amazon RDS",
  ...
  {
    question: "Ein AWS-Service zur Erstellung und Bereitstellung von Machine Learning-Modellen in der Cloud ist?",
  ...
  {
    question: "Ein AWS-Service zur Durchführung von Serverless Computing in der Cloud ist?",
    option1: "Amazon EC2",
    option2: "Amazon ECS",
    option3: "AWS Lambda",
    option4: "Amazon S3",
  ...
  {
    question: "Ein AWS-Service zur Erstellung einer verteilten und skalierbaren Anwendungsarchitektur ist?",
    option1: "Amazon EC2",
    option2: "Amazon S3",
    option3: "Amazon SQS",
  ...
  {
    question: "Ein AWS-Service zur automatisierten Bereitstellung von Anwendungen in der Cloud ist?",
  ...
  {
    question: "Ein AWS-Service zur Echtzeit-Übertragung und -Verarbeitung von Daten ist?",
  ...
  {
    question: "Ein AWS-Service zur Erstellung einer verteilten Anwendungsarchitektur mit asynchroner Kommunikation ist?",
    option1: "Amazon EC2",
    option2: "Amazon S3",
    option3: "Amazon SNS",
    option4: "Amazon SQS",
  ...
  {
    question: "Ein AWS-Service zur Zentralisierung und Analyse von Anwendungslogs ist?",
    option1: "Amazon CloudFront",
  ...
  {
    question: "Ein AWS-Service zur Echtzeitanalyse von Datenbankabfragen ist?",
  ...
  {
    question: "Ein AWS-Service für Lastenausgleich und Skalierung von Webanwendungen ist?",
  ...
  {
    question: "Ein AWS-Service zur Erstellung eines virtuellen privaten Netzwerks (VPN) zwischen der lokalen Infrastruktur und AWS ist?",
    option1: "Amazon VPC",
  ...
  {
    question: "Ein AWS-Service zur Echtzeitüberwachung und -Benachrichtigung von Anwendungsdaten ist?",
    option1: "Amazon CloudWatch",
  ...
  {
    question: "Ein AWS-Service zur Verwaltung und Orchestrierung von containerbasierten Anwendungen ist?",
    option1: "Amazon EKS",
    option2: "Amazon EC2",
    option3: "AWS Lambda",
    option4: "Amazon S3",
  ...
  {
    question: "Ein AWS-Service zur Echtzeitdatenübertragung zwischen Anwendungen ist?",
    option1: "Amazon SQS",
  ...
  {
    question: "Ein AWS-Service zur Ermöglichung der Netzwerkverbindung zwischen lokalen Systemen und AWS-Ressourcen ist?",
    option1: "Amazon VPC",
    option2: "AWS Direct Connect",
    option3: "Amazon Route 53",
  ...
  {
    question: "Ein AWS-Service zur kontinuierlichen Überwachung und Verbesserung der Sicherheit von AWS-Ressourcen ist?",
